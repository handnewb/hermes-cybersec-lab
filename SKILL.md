...
| `references/tools-ecosystem.md` | 131+ tools across 18 categories with install commands |
| `references/skills-catalog.md` | 382 categorized Hermes procedural skills |
